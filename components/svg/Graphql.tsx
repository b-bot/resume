const Graphql = (props) => (
  ...
  >
    <g fill="#e535ab">
      <path
        d="m122-.4h16.6v320.3h-16.6z"
        transform="matrix(-.866 -.5 .5 -.866 163.3196 363.3136)"
      />
      <path d="m39.8 272.2h320.3v16.6h-320.3z" />
      <path
        d="m37.9 312.2h185v16.6h-185z"
        transform="matrix(-.866 -.5 .5 -.866 83.0693 663.3409)"
      />
      <path
        d="m177.1 71.1h185v16.6h-185z"
        transform="matrix(-.866 -.5 .5 -.866 463.3409 283.0693)"
      />
      <path
        d="m122.1-13h16.6v185h-16.6z"
        transform="matrix(-.5 -.866 .866 -.5 126.7903 232.1221)"
      />
      <path
        d="m109.6 151.6h320.3v16.6h-320.3z"
        transform="matrix(-.5 -.866 .866 -.5 266.0828 473.3766)"
      />
      <path d="m52.5 107.5h16.6v185h-16.6z" />
      <path d="m330.9 107.5h16.6v185h-16.6z" />
      <path
        d="m262.4 240.1h14.5v160.9h-14.5z"
        transform="matrix(-.5 -.866 .866 -.5 126.7953 714.2875)"
      />
